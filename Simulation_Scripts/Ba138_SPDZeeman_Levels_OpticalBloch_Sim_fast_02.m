...
%pol_minus_s = sqrt((cos(theta)^2)/2); pol_0_s = sqrt(sin(theta)^2); pol_plus_s = sqrt((cos(theta)^2)/2);
%pol_minus_d = sqrt((cos(theta)^2)/2); pol_0_d = sqrt(sin(theta)^2); pol_plus_d = sqrt((cos(theta)^2)/2);
