RepumpStartTime = 10;
RepumpEndTime = 110;
AWGSP1StartTime = RepumpEndTime;
AWGSP1EndTime = AWGSP1StartTime + 50;
OpticalPumpSPStartTime = AWGSP1EndTime + 50;
OpticalPumpSPEndTime = OpticalPumpSPStartTime + 100;
PulseSPStartTime = OpticalPumpSPEndTime;
PulseSPEndTime = PulseSPStartTime+100;
AWGSP2StartTime = PulseSPEndTime;
AWGSP2EndTime = AWGSP2StartTime + 50;
FluorescenceStartTime = AWGSP2EndTime + 50;
FluorescenceEndTime = FluorescenceStartTime + 100;
AWGMStartTime = FluorescenceEndTime;
AWGMEndTime = AWGMStartTime + 50;
OpticalPumpMStartTime = AWGMEndTime + 50;
OpticalPumpMEndTime = OpticalPumpMStartTime + 100;
PulseMStartTime = OpticalPumpMEndTime;
...
OpticalPump_493(time>=OpticalPumpMStartTime & time<OpticalPumpMEndTime)=1;
...
Cool_650(time>=OpticalPumpMStartTime & time<OpticalPumpMEndTime) = 1;
...
AWGSignal(time>=AWGSP1StartTime & time<AWGSP1EndTime) = 1;
AWGSignal(time>=AWGSP2StartTime & time<AWGSP2EndTime) = 1;
AWGSignal(time>=AWGMStartTime & time<AWGMEndTime) = 1;
...
subplot(6,1,6);
hold off
area(time,AWGSignal,'facecolor',[0.5 0.5 0.5],'linestyle','none');
hold on
plot(time,AWGSignal,'k','linewidth',2);
set(gca,'XTick',[0 time(end)]);
set(gca,'XTickLabel',{''; ''});
set(gca,'YTick',[0 1]);
set(gca,'YTickLabel',{''; ''});
