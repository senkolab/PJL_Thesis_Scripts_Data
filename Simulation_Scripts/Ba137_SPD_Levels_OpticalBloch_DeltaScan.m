...
for hh=1:numel(Delta_S_array)
    for hhh=1:numel(Delta_D_array)
        ...
        Delta_S2 = 2*pi*(Delta_S_array(hh)+150);
        Delta_D0 = 2*pi*Delta_D_array(hhh);
        Delta_D1 = 2*pi*(Delta_D_array(hhh)+100);
        Delta_D2 = 2*pi*(Delta_D_array(hhh)+0);
        Delta_D3 = 2*pi*(Delta_D_array(hhh)+100);
        Ba137_SPD_Levels_OpticalBloch_Sim_fast
