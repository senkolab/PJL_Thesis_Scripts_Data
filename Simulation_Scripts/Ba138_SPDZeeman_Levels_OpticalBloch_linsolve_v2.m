...
pol_minus_s = sqrt((cos(theta_s)^2)/2); pol_0_s = sqrt(sin(theta_s)^2); pol_plus_s = sqrt((cos(theta_s)^2)/2);
pol_minus_d = sqrt((cos(theta_d)^2)/2); pol_0_d = sqrt(sin(theta_d)^2); pol_plus_d = sqrt((cos(theta_d)^2)/2);
...
cs0_prime = -1i.*Delta_SP01.*cs0 + 1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cp0 + sqrt(2/3).*pol_plus_s.*cp1);
cs0_prime_conj = conj(-1i.*Delta_SP01.*cs0_conj + 1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cp0_conj + sqrt(2/3).*pol_plus_s.*cp1_conj));
...
cp0_prime_conj = conj(1i.*Delta_zp.*cp0_conj...
...
%    - 1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cs0 + sqrt(2/3).*pol_minus_s.*cs1)...
%    - 1i.*(Omega_D/2).*(pol_plus_d.*cd0 + sqrt(2/3).*pol_0_d.*cd1 + sqrt(1/3).*pol_minus_d.*cd2);
%cp0_prime_conj = conj(1i.*(Delta_SP01 + Delta_zp).*cp0_conj...
%    - 1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cs0_conj + sqrt(2/3).*pol_minus_s.*cs1_conj)...
%    - 1i.*(Omega_D/2).*(pol_plus_d.*cd0_conj + sqrt(2/3).*pol_0_d.*cd1_conj + sqrt(1/3).*pol_minus_d.*cd2_conj));

cp1_prime = -1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cs1 - sqrt(2/3).*pol_plus_s.*cs0)...
    - 1i.*(Omega_D/2).*(sqrt(1/6).*pol_plus_d.*cd1 - sqrt(1/3).*pol_0_d.*cd2 + sqrt(1/2).*pol_minus_d.*cd3);
cp1_prime_conj = conj(-1i.*(Omega_S/2).*(sqrt(1/3).*pol_0_s.*cs1_conj - sqrt(2/3).*pol_plus_s.*cs0_conj)...
...
%    - 1i.*(Omega_S/2).*(sqrt(2/3).*pol_plus_s.*cs0 + sqrt(1/3).*pol_0_s.*cs1)...
%    - 1i.*(Omega_D/2).*(sqrt(1/3).*pol_plus_d.*cd1 + sqrt(2/3).*pol_0_d.*cd2 + pol_minus_d.*cd3);
%cp1_prime_conj = conj(1i.*Delta_SP01.*cp1_conj...
%    - 1i.*(Omega_S/2).*(sqrt(2/3).*pol_plus_s.*cs0_conj + sqrt(1/3).*pol_0_s.*cs1_conj)...
%    - 1i.*(Omega_D/2).*(sqrt(1/3).*pol_plus_d.*cd1_conj + sqrt(2/3).*pol_0_d.*cd2_conj + pol_minus_d.*cd3_conj));

sigma_t = nan(numel(cs0),numel(t));
sigma_t(:,1) = 0;
sigma_t(1,1) = 1;
