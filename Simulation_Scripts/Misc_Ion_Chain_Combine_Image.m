...
for exp_ind = 1:Set_num
    ...
    pngFilepath = [Filepath 'Processed_images\' 'Individual_PNG\Pcolor_image_'...
        num2str(exp_ind-1,'%02.f') '\'];
    ...
    pdfFilepath = [Filepath 'Processed_images\' 'Aggregated_Image\'];
    p = pcolor(B);
    daspect([1 1 1]);
    cc = colorbar;
    xlabel('x pixel');
    ...
    CustomSaveAsPDF;
    pngFilepath = pdfFilepath;
    pngfilename = ['Pcolor_image_' num2str(exp_ind-1,'%02.f') '.png'];
    CustomSaveAsPNG;
end